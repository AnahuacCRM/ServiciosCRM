...
{
    public class srvCambioSGASTDNController : ApiController
    {
        ...
        public srvCambioSGASTDNController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        [HttpPost]
        public HttpResponseMessage ActualizaSGASTDN(CambioSGASTDN cambiosgastdn)
        {
            try
            {
                if (cambiosgastdn == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "el objeto CambioSGASTDN no puede ir vacio");
                }

                return Request.CreateResponse<bool>(HttpStatusCode.OK, _prospectProcessor.UpdateCambioSGASTDN(cambiosgastdn));
            }
