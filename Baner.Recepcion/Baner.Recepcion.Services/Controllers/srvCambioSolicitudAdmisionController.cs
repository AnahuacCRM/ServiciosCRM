...
{
    [Authorize]
    public class srvCambioSolicitudAdmisionController : ApiController
    {
        private readonly ILogger _logger;
        private readonly IProspectProcessor _prospectProcessor;

        public srvCambioSolicitudAdmisionController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        [HttpPost]
        public HttpResponseMessage ActualizaSolicitudAdmision(CambiaSolicitudAdmision cambiasolicitudadmision)
        {
