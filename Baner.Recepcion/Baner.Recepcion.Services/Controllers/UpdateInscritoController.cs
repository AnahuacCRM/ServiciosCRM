...
{
    [Authorize]
    public class UpdateInscritoController : ApiController
    {
        ...
        public UpdateInscritoController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        /// <summary>
        /// Metodo para actualizar Inscrito en CRM
        /// </summary>
        /// <param name="inscrito">Clase que define la estructura de Inscrito</param>
        /// <returns>Respuesta en formato HTTPResponseMessage, devuelve un OK si es correcto</returns>
        [HttpPost]
        public HttpResponseMessage Post(Inscrito inscrito)
        {
            ...
            try
            {
                if (inscrito == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "inscrito no puede ir vacio");
                }
