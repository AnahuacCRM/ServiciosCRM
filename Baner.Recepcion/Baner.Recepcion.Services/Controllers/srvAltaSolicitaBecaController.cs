...
namespace Baner.Recepcion.Services.Controllers
{
    ...
    public class srvAltaSolicitaBecaController : ApiController
    {
        ...
        public srvAltaSolicitaBecaController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
            _prospectProcessor = prospectProcessor;
        }
        [HttpPost]
        public HttpResponseMessage CreateSolicitaBeca(SolicitaBeca solicitaBeca)
        {
            ...
            try
            {
                ...
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "El objeto SolicitaBeca no puede ir vacio");
                }
