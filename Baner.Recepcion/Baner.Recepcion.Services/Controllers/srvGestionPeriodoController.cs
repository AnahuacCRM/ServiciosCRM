...
{
    [Authorize]
    public class srvGestionPeriodoController : ApiController
    {
        ...
        public srvGestionPeriodoController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        /// <summary>
        /// Metodo para actualizar CatalogoPeriodos en CRM
        /// </summary>
        /// <param name="catalogoPeriodos">Clase que define la estructura de CatalogoPeriodos</param>
        /// <returns>Respuesta en formato HTTPResponseMessage, devuelve un OK si es correcto</returns>
        //[HttpPost]
        public HttpResponseMessage Post(CatalogoPeriodos catalogoPeriodos)
        {

            try
            {
                if (catalogoPeriodos == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "catalogoPeriodos no puede ir vacio");
                }

                return Request.CreateResponse<bool>(HttpStatusCode.OK, _prospectProcessor.UpdateCatalogoPeriodos(catalogoPeriodos));
            }
