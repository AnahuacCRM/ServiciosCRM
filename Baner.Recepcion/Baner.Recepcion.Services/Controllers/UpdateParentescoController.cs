...
{
    [Authorize]
    public class UpdateParentescoController : ApiController
    {
        ...
        public UpdateParentescoController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        /// <summary>
        /// Metodo para actualizar Parentesco en CRM
        /// </summary>
        /// <param name="parentesco">Clase que define la estructura de Parentesco</param>
        /// <returns>Respuesta en formato HTTPResponseMessage, devuelve un OK si es correcto</returns>
        [HttpPost]
        public HttpResponseMessage Post(Parentesco parentesco)
        {
            ...
            try
            {
                if (parentesco == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "parentesco no puede ir vacio");
                }

                return Request.CreateResponse<bool>(HttpStatusCode.OK, _prospectProcessor.UpdateParentesco(parentesco));
            }
