...
{
    [Authorize]
    public class UpdateExaminadoController : ApiController
    {
        ...
        public UpdateExaminadoController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        /// <summary>
        /// Metodo para actualizar Examinado en CRM
        /// </summary>
        /// <param name="exam">Clase que define la estructura de examinado</param>
        /// <returns>Respuesta en formato HTTPResponseMessage, devuelve un OK si es correcto</returns>
        [HttpPost]
        public HttpResponseMessage Post(Examinado exam)
        {
            ...
            try
            {
                if (exam == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "Examinado no puede ir vacio");
                }

                return Request.CreateResponse<bool>(HttpStatusCode.OK, _prospectProcessor.UpdateExaminado(exam));
            }
