...
{
    public class srvObtenerEstadosController : ApiController
    {
        private readonly ILogger _logger;
        private readonly IProspectProcessor _prospectoProcessor;
        public srvObtenerEstadosController(ILogger plogger, IProspectProcessor pibannerProcessor)
        {
            _logger = plogger;
        ...
        [HttpGet]
        public HttpResponseMessage ObtenerEstados()
        {
            try
            {

                // return Request.CreateResponse<RespuestaCoincidencia>(HttpStatusCode.OK, _bannerProcessor.ConsultarCoincidencias(Prospecto));
                return Request.CreateResponse<List<Estado>>(HttpStatusCode.OK, _prospectoProcessor.GetCatalogoEstados());
            }
