...
namespace Baner.Recepcion.Services.Controllers
{
    ...
    public class srvAltaOtorgaBecaController : ApiController
    {
        ...
        public srvAltaOtorgaBecaController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        [HttpPost]
        public HttpResponseMessage OtorgamientoBeca(OtorgamientoBeca otorgabeca)
        {
            ...
            try
            {
                ...
                return Request.CreateResponse<bool>(HttpStatusCode.OK, _prospectProcessor.OtorgamientoaBeca(otorgabeca));
            }
