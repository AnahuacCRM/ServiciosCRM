...
{
    public class srvCambioFechaExamenAdmisionController : ApiController
    {
        ...
        public srvCambioFechaExamenAdmisionController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        [HttpPost]
        public HttpResponseMessage ActualizaFechaExamenAdmision(FechaExamenAdmision fechaExamenAdm)
        {

            try
            {
                if (fechaExamenAdm == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "el objeto FechaExamenAdmision no puede ir vacio");
                }

                return Request.CreateResponse<bool>(HttpStatusCode.OK, _prospectProcessor.FechaExamenAdmision(fechaExamenAdm));
            }
