...
{
    public class srvObtenerPaisesController : ApiController
    {
        private readonly ILogger _logger;
        private readonly IProspectProcessor _prospectoProcessor;
        public srvObtenerPaisesController(ILogger plogger, IProspectProcessor pibannerProcessor)
        {
            _logger = plogger;
        ...
        public HttpResponseMessage ObtenerPaises()
        {
            try
            {
                ...
                return Request.CreateResponse<List<Pais>>(HttpStatusCode.OK, _prospectoProcessor.GetCatalogoPaises());
            }
