...
{
    public class srvCambioPropedeuticoController : ApiController
    {
        private readonly ILogger _logger;
        private readonly IProspectProcessor _prospectProcessor;

        public srvCambioPropedeuticoController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        [HttpPost]
        public HttpResponseMessage ActualizarPropedeutico(Propedeutico propedeutico)
        {
            try
            {
                if (propedeutico == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "El objeto Propedeutico no puede ir vacio");
                }
