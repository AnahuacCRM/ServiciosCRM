...
{
    [Authorize]
    public class UpdateResultadoExamenController : ApiController
    {
        private readonly ILogger _logger;
        private readonly IProspectProcessor _prospectProcessor;

        public UpdateResultadoExamenController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
            _prospectProcessor = prospectProcessor;
        }

        public HttpResponseMessage Post(ResultadoExamen resultadoExamen)
        {
            try
            {
