...
{
    public class srvObtenerColegiosController : ApiController
    {
        private readonly ILogger _logger;
        private readonly IProspectProcessor _prospectoProcessor;
        public srvObtenerColegiosController(ILogger plogger, IProspectProcessor pibannerProcessor)
        {
            _logger = plogger;
        ...
        [HttpGet]
        public HttpResponseMessage ObtenerColegios()
        {
            try
            {

                // return Request.CreateResponse<RespuestaCoincidencia>(HttpStatusCode.OK, _bannerProcessor.ConsultarCoincidencias(Prospecto));
                return Request.CreateResponse<List<Colegios>>(HttpStatusCode.OK, _prospectoProcessor.GetCatalogoColegios());
            }
