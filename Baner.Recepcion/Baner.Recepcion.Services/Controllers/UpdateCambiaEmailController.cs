...
{
    [Authorize]
    public class UpdateCambiaEmailController : ApiController
    {
        ...
        public UpdateCambiaEmailController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        /// <summary>
        /// Metodo para crear, actualizar o eliminar  CambiaEmail en CRM
        /// </summary>
        /// <param name="cambiaEmail">Clase que define la estructura de CambiaEmail</param>
        /// <returns>Respuesta en formato HTTPResponseMessage, devuelve un OK si es correcto</returns>
        [HttpPost]
        public HttpResponseMessage Post(CambiaEmail cambiaEmail)
        {
            ...
            try
            {
                if (cambiaEmail == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "cambiaEmail no puede ir vacio");
                }

                return Request.CreateResponse<bool>(HttpStatusCode.OK, _prospectProcessor.UpdateCambiaEmail(cambiaEmail));
            }
