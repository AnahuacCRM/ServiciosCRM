...
{
    public class srvCambioTransferenciaController : ApiController
    {
        ...
        public srvCambioTransferenciaController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        public HttpResponseMessage ActaulizaTransferencia(Transferencia transferencia)
        {
            try
            {
                if (transferencia == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "el objeto Transferencia no puede ir vacio");
                }
