...
{
    [Authorize]
    public class UpdateRechazadoController : ApiController
    {
        ...
        public UpdateRechazadoController(ILogger logger, IProspectProcessor prospectProcessor)
        {
            _logger = logger;
        ...
        /// <summary>
        /// Metodo para actualizar rechazado en CRM
        /// </summary>
        /// <param name="rechazado">Clase que define la estructura de rechazado</param>
        /// <returns>Respuesta en formato HTTPResponseMessage, devuelve un OK si es correcto</returns>
        [HttpPost]
        public HttpResponseMessage Post(Rechazado rechazado)
        {
            ...
            try
            {
                if (rechazado == null)
                {
                    return Request.CreateErrorResponse(HttpStatusCode.BadRequest, "rechazado no puede ir vacio");
                }

                return Request.CreateResponse<bool>(HttpStatusCode.OK, _prospectProcessor.UpdateRechazado(rechazado));
            }
