...
{
    /// <summary>
    /// Clase que define a un nuevo prospecto en CRM
    /// </summary>
    public class NewProspect : BusinessTypeBase
    {
        ...
        public string NameOportunidad { get; set; }
        /// <summary>
        ...
        public string ColegioProcedencia { get; set; } //Account Number
        ...
        public string CodigoTipoAlumno { get; set; }
        //6s
        ...
        public string CodigoTipoadmision { get; set; }
        ...
        //[Required(AllowEmptyStrings = false, ErrorMessage = "El estado de nacimiento es requerido")]
        [MaxLength(3, ErrorMessage = "La longitud máxima del estado de nacimiento es de {1} caracteres")]
        public string EstadoNacimiento { get; set; }

        [MaxLength(50, ErrorMessage = "La longitud máxima de la ciudad de nacimiento es de {1} caracteres")]
