...
{
    [TestClass]
    public class WebApiCambioTipoAdmisionTest
    {
        #region Propiedades
        ILogger _logger;
        ...
        UpdateCambioTipoAdmisionController _updateCambioTipoAdmisionController;
        Token token;
        #endregion
        ...
        public void Initialize()
        {
            ...
            _updateCambioTipoAdmisionController = new UpdateCambioTipoAdmisionController(_logger, _prospectprocessor);

            _updateCambioTipoAdmisionController.Request = new HttpRequestMessage()
            {
            ...
            {
                OportunidadIdCRM = new Guid("754C9DCE-3845-E611-80ED-6C3BE5A8380C"),
                IdBanner = "00294955",
                TipoAdmision = "AA",
                TipoAlumno = "N",
                VPDI = "UAS",
        ...
        [TestMethod]
        public void URLCambioTipoAdmisionSucessTest()
        {
            //Arrange
            var url = "http://localhost:21292/Api/UpdateCambioTipoAdmision";
            HttpClient proxy = new HttpClient();
            proxy.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.AccessToken);
            //Act
            string json = JsonConvert.SerializeObject(cambiotipoadmision);
            var response = proxy.PostAsJsonAsync(url, cambiotipoadmision).Result;
        ...
        [TestMethod]
        public void CambioTipoAdmisionControlerSuccessTest()
        {
            //Arrange


            //Act
            var resultado = _updateCambioTipoAdmisionController.Post(cambiotipoadmision);
        ...
        [TestMethod]
        public void CambioTipoAdmisionIDBANNERInexistenteSuccessTest()
        {
            //Arrange

            cambiotipoadmision.IdBanner = "123";
            //Act
            var resultado = _updateCambioTipoAdmisionController.Post(cambiotipoadmision);
            ...
            if (resultado.StatusCode != HttpStatusCode.OK)
            {
                var msgresultado = resultado.Content.ReadAsStringAsync().Result;
                _logger.Infomacion(msgresultado);
                var expectedErrorMessage = "El IdBanner no existe";
