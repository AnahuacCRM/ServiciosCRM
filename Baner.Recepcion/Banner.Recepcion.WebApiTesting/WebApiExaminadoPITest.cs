...
{
    [TestClass]
    public class WebApiExaminadoPITest
    {
        #region Propiedades
        ILogger _logger;
        ...
        UpdateExaminadoPIController _updateexaminadopicontroller;
        Token token;
        #endregion
        ...
        public void Initialize()
        {
            ...
            _updateexaminadopicontroller = new UpdateExaminadoPIController(_logger, _prospectprocessor);

            _updateexaminadopicontroller.Request = new HttpRequestMessage()
            {
        ...
        [TestMethod]
        public void UpdatefromURLExaminadoPISucessTest()
        {

            //Arrange
            var url = "http://localhost:21292/Api/UpdateExaminadoPI";
            HttpClient proxy = new HttpClient();
            proxy.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.AccessToken);

            //Act
            string json = JsonConvert.SerializeObject(examinadopi);
            var response = proxy.PostAsJsonAsync(url, examinadopi).Result;
        ...
        [TestMethod]
        public void UpdatefromControlerExaminadoPISuccessTest()
        {
            //Arrange
            ...
            //Act
            var resultado = _updateexaminadopicontroller.Post(examinadopi);
        ...
        [TestMethod]
        public void ExaminadoPIIDBANNERInexistenteSuccessTest()
        {
            //Arrange

            examinadopi.IdBanner = "123";
            //Act
            var resultado = _updateexaminadopicontroller.Post(examinadopi);
