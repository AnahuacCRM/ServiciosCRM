...
{
    [TestClass]
    public class WebApiTransferenciaTest
    {
        #region Propiedades
        ILogger _logger;
        ...
        UpdateTransferenciaController _updateTransferenciaController;
        Token token;
        #endregion
        ...
        public void Initialize()
        {
            ...
            _updateTransferenciaController = new UpdateTransferenciaController(_logger, _prospectprocessor);

            _updateTransferenciaController.Request = new HttpRequestMessage()
            {
            ...
            #region Informacion de Transferencia
        ...
        [TestMethod]
        public void UpdatefromURLTransferenciaSucessTest()
        {

            //Arrange
            var url = "http://localhost:21292/Api/UpdateTransferencia";
            HttpClient proxy = new HttpClient();
            proxy.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token.AccessToken);
            //Act
            string json = JsonConvert.SerializeObject(transferencia);
            var response = proxy.PostAsJsonAsync(url, transferencia).Result;
        ...
        public void UpdatefromControllerTransferenciaSuccessTest()
        {
            ...
            //Act
            var resultado = _updateTransferenciaController.Post(transferencia);
